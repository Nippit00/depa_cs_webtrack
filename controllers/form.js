  ...
  try {
    ...
    db.query(qFechdata, [solutionParam.solutionID], (err, fechData) => {
      ...
      if (fechData && fechData.length > 0) {
        db.query(qUpdate, [postData.currentDateTime, postData.Q1, postData.Q2, postData.Q3, postData.Q4, postData.Q5, postData.Q6, postData.Q7, postData.Q8, postData.Q9, solutionParam.solutionID], (err, updateData) => {
